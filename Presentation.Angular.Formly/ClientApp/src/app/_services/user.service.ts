...
export class UserService {
  ...
  createUser(
    ...
    const u = new User(0, userName, email);
    u.password = password;
    u.profile = new Profile(0,
      "00000000-0000-0000-0000-000000000000",
      firstName,
      lastName,
      new Date(1940, 1, 1),
      "c78227a5-ca89-4b9d-aa6a-e5d779b94b20");
    u.claims = new Array<Claim>(new Claim("00000000-0000-0000-0000-000000000000",
